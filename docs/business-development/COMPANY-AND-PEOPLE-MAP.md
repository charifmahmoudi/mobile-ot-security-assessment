# Morocco company and people map
...
|---|---|---|---|---|
| [Hicham IDOUHCINE](https://ma.linkedin.com/in/hicham-idouhcine) | Water Branch maintenance technician specialising in electricity, automation, supervision, telemanagement, PLC and SCADA for treatment and pumping facilities | Direct technical evaluator for a pumping or treatment baseline | A / High | Who owns the approved inventory and review process for one automation environment? |
| [Sami LAKNIZI](https://ma.linkedin.com/in/sami-laknizi-523b45b4) | Automation, instrumentation and SCADA-training signal; publicly associated with pumping-station automation and supervision | Strong lab, training and technical-validation route | A / High | Is there a representative training environment for a passive evidence demonstration? |
| [Abderrahim Samir](https://ma.linkedin.com/in/abderrahim-samir-a34a87140) | Public signal for automation, instrumentation and telemanagement leadership | Potential technical sponsor for a bounded telemanagement assessment | A / Medium | Which treatment, reservoir or pumping area has the clearest inventory-confidence problem? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Abousselham Otmane](https://ma.linkedin.com/in/abousselham-%D8%A3%D8%A8%D9%88%D8%B3%D9%84%D9%87%D8%A7%D9%85-otmane-%D8%B9%D8%AB%D9%85%D8%A7%D9%86-04653618) | Desalination Program Manager; water-emergency and SWRO-modernisation leadership | Strategic programme and commissioning sponsor | A / High | Where does EPC-to-operator asset evidence create the most acceptance friction? |
| [Fatima Ezzahra AKHRIF](https://ma.linkedin.com/in/fatima-ezzahra-akhrif-3940b296/en) | Operations-performance, project-control and QHSE signals across desalination programmes | Governance, evidence custody and acceptance criteria | A / Medium | Which evidence and sign-offs are required before a process area is operationally accepted? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Njoumi Kamal](https://ma.linkedin.com/in/njoumi-kamal-93054418b) | Liquid-sanitation business-affairs responsibility in the Anfa–El Fida prefectural directorate | Wastewater project and handover route | A / High | Which current sanitation work package would benefit from an evidence-linked asset handover? |
| [Youssef Haboul](https://ma.linkedin.com/in/youssef-haboul) | Hydraulic and environmental engineer with drinking-water, sanitation and treatment-plant background | Water/wastewater technical evaluator | A / High | Where is the largest gap between approved records and field reality? |
| [Houssame Kablani](https://ma.linkedin.com/in/houssame-kablani) | Hydroinformatics, hydrosystems, hydraulic modelling, GIS and wastewater background | Bridge between field evidence, GIS and models | A / Medium | How are new or conflicting field assets reconciled into GIS and hydraulic models? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Yasser Moufid](https://ma.linkedin.com/in/yasser-moufid-44114965) | Engineer specialising in sanitation and water-resource management | Direct water/wastewater technical route | A / High | Could one GIS-recognition or sanitation work area be used for a passive evidence review? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Kamal NZOULOU](https://ma.linkedin.com/in/kamal-nzoulou-1a836648) | GIS, SCADA/BCC, GMAO and multi-utility digital-programme signals | Strong digital-asset and OT convergence route | A / High | Where do GIS, GMAO and SCADA records currently disagree or require manual reconciliation? |
| [Othmane Atfaoui](https://ca.linkedin.com/in/othmane-atfaoui-0561701a2) | Sanitation, hydraulics and network-performance background | Sanitation and hydraulic-performance evaluator | A / High | Which bounded sanitation or pressure-zone project has a measurable handover problem? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Yassine Ouahbi](https://ma.linkedin.com/in/yassine-ouahbi-056544b2) | Water/sanitation operational-readiness signals and predecessor-utility experience | Operations and transition route | A / High | Which telemanagement or sectorisation project has an upcoming operational handover? |
| [Mohamed Amine CHADLI](https://ma.linkedin.com/in/amine-chadli) | Hydraulic, drinking-water supply, pumping and reservoir engineering activity | Pumping/reservoir technical evaluator | A / Medium | Which pumping or reservoir area has unresolved asset identities? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Kacem IDRISSI RAJI](https://ma.linkedin.com/in/kacem-idrissi-raji-a6329632) | Network planning, asset management, lifecycle-cost and ISO 55001 activity | Asset-governance and handover route | A / High | How is field evidence incorporated into lifecycle and asset-management decisions? |
| [Ahmed DEROUICH](https://ma.linkedin.com/in/ahmed-derouich-2411ba24) | Distribution-techniques background | Operations referral | B / Medium | Is your current perimeter water, electricity or multiservice, and who owns the water-network baseline? |
| [مهدي بوحصيرة](https://ma.linkedin.com/in/%D9%85%D9%87%D8%AF%D9%8A-%D8%A8%D9%88%D8%AD%D8%B5%D9%8A%D8%B1%D8%A9-52b86926) | Public hydraulic-engineering interest at the SRM | Hydraulic technical referral | B / Medium | Who leads hydraulic sector analysis and network-performance evidence? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Abdellah TAHROUCH](https://ma.linkedin.com/in/abdellahtahrouch) | Civil and hydraulic engineer specialising in water-supply and wastewater infrastructure | Strong water/wastewater project route | A / High | Which active works package needs field-to-record reconciliation before acceptance? |
| [Zaid Aarab](https://ma.linkedin.com/in/zaid-aarab-b94664153) | Wastewater technician with pumping-optimisation and maintenance-audit activity | Direct wastewater-operations evaluator | A / High | Could one lift station or pumping asset be used for a passive evidence baseline? |
| [Abdessamad GHACHA](https://ma.linkedin.com/in/abdessamad-ghacha/en) | Sanitation-project management responsibility | Project sponsor or commissioning route | A / High | What evidence is required from contractors before sanitation-project acceptance? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [NABIL LAAOUAOUCHA](https://ma.linkedin.com/in/nabil-laaouaoucha-379369108) | Budget, management-control and multi-year water/sanitation planning activity | Economic and programme-governance route | A / High | Where does weak acceptance evidence create rework, delay or programme-control risk? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Maroine EL HAFARI](https://ma.linkedin.com/in/maroine-el-hafari-a226ab97) | Senior engineering background at the SRM | Engineering and programme-delivery route | A / Medium | Which rural, pumping or sanitation project has an upcoming acceptance point? |
| [Ahmed Ait Ali](https://ma.linkedin.com/in/ahmed-ait-ali-9b4b03100) | Electrical maintenance, automation and instrumentation background | Direct technical evaluator | A / High | Could one pumping or treatment control area support a passive-first pilot? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Abdellah Benciba](https://ma.linkedin.com/in/abdellah-benciba-0202b1223) | Public sanitation-network operations and management context | Wastewater-operations route | A / Medium | Which wastewater network or treatment area has an evidence or maintenance-handover need? |
...
| Person | Public professional signal | Atlas relevance | Priority / confidence | First question |
|---|---|---|---|---|
| [Fettah Bourass](https://ma.linkedin.com/in/fettah-bourass-b7102619a) | QHSE and energy-management capability signal | Controlled-scope, evidence-custody and governance route | A / Medium | Who owns QHSE and technical acceptance for one treatment or network-renewal project? |
...
3. Njoumi Kamal and Youssef Haboul — Casablanca–Settat wastewater and hydraulic operations;
4. Anas ERRAGALA — Souss–Massa hydraulic projects;
5. Yasser Moufid — Oriental water and sanitation;
6. Kamal NZOULOU and Othmane Atfaoui — Marrakech–Safi digital assets and hydraulics;
7. Yassine Ouahbi — Fès–Meknès operations and transition;
8. Kacem IDRISSI RAJI — Rabat–Salé–Kénitra asset management;
9. Abdellah TAHROUCH, Zaid Aarab and Abdessamad GHACHA — Tanger–Tétouan–Al Hoceïma water, wastewater and projects;
10. NABIL LAAOUAOUCHA — Béni Mellal–Khénifra programme control;

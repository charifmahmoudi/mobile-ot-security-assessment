...
- Epiroc described Tizert as a digitalized greenfield mine using personnel/vehicle tracking, event automation and MQTT Sparkplug ([Epiroc, 26 Nov 2024](https://www.epiroc.com/en-hk/newsroom/2024/epiroc-partners-with-managem-for-digitalization-of-tizert-project-in-morocco)). Managem now reports 2025 production and an 18-year mine life, so this is an operating-asset reconciliation opportunity, not only commissioning research ([Tizert project](https://www.managemgroup.com/en/tizert-mine)).
